export const ABOUT_US = [
  ...
  },
  {
    ...
    subTitle:
      "We accept all talents in the entertainment industry including acting, singing, dancing, writing, modeling, TV hosting in addition to voiceover, directing and any other roles within the production staff. If you can’t find your talent in the drop-down menu, please select “other” and specify it in the respective field",
  },
  {
  ...
  },
  {
    ...
    subTitle:
      "When the talent seeker posts an opportunity for the first time, Casting Arabia requests from them to upload a verification document. While we do our best to verify the posted opportunities as well, we advise our talent to do their own background check as well.",
  },
  {
